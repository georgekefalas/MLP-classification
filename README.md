...
The project uses separate training and testing datasets (`train.txt` and `test.txt`) in TXT format and includes functionality for training, evaluation and prediction. A **Report** is also included, with the **first page showing the categories used** in the SDT problem.
